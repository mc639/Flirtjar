                    ...
                    <div class='col-lg-5 col-md-5 col-sm-5  col-xs-12'>
                        ...
                        <div id='carousel-example-generic' class='carousel slide' data-ride='carousel' data-interval='false'>
                           ...
                           $htmldata .="</div>
							...
							for($pi=0;$pi<count($SelectProductImage);$pi++)
							{
								$htmldata .="<li><img src='upload_data/productimage/thumb/".$SelectProductImage[$pi]['ImageName']."' alt='1_tn.jpg'></li>";
							}	
                            $htmldata .="</ul>
                        </div>
                        <div class='clearfix'>&nbsp;
                            ...
                            <ul class='social-icon'>
                                <li><a href=''><i class='fa fa-facebook text-facebook fa'></i></a></li>
                                <li><a href=''><i class='fa fa-twitter text-twitter fa'></i></a></li>
                                <li><a href=''><i class='fa fa-google-plus text-google fa'></i></a></li>
                            </ul>-->
                        </div>
                    </div>
                                ...
                                <div class='col-md-6'>
                                    ...
                                    $htmldata .="<li onClick='add_class_".$p."();' id='SActive_".$p."' name='SActive_".$p."' class = 'RemoveClass123'>
										...
										<script>
                                            ...
                                            <li><a href='#'>XS</a></li>
                                            <li><a href='#'>XXL</a></li>
                                            <div class='alert alert-danger error-message text-red text-error-detail' role='alert'>Please Select Size</div>-->";
											}
										}
										if($StockFlag == 0)
										{
...
<script type="text/javascript" language = "javascript">
	...
	function AddToWishlistQuickView(fid)
	{
		...
		?>		
				...
				//$("#HeaderSubmit").attr('onClick',"window.location = 'login?from=<?php echo $_SESSION['from']; ?>'");
				location.href = "login?from=index";
		<?php
			}
			else
			{
